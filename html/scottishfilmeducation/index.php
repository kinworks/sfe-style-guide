...
<!--[if gt IE 8]><!--> <html lang="en" class="guide no-js"> <!--<![endif]-->
  ...
  <head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="../<?php echo $csssite; ?>/css/output/global.css">
    <link rel="stylesheet" href="../<?php echo $csssite; ?>/css/solarized_dark.css">
    <!--[if IE 8]>  
...
window.grunticon=function(e){if(e&&3===e.length){var t=window,n=!(!t.document.createElementNS||!t.document.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect||!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")||window.opera&&-1===navigator.userAgent.indexOf("Chrome")),o=function(o){var a=t.document.createElement("link"),r=t.document.getElementsByTagName("script")[0];a.rel="stylesheet",a.href=e[o&&n?0:o?1:2],a.media="only x",r.parentNode.insertBefore(a,r),setTimeout(function(){a.media="all"})},a=new t.Image;a.onerror=function(){o(!1)},a.onload=function(){o(1===a.width&&1===a.height)},a.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="}};
			...
			grunticon(["../<?php echo $csssite; ?>/assets-icons/output/icons.data.svg.css", "../<?php echo $csssite; ?>/assets-icons/output/icons.data.png.css", "../<?php echo $csssite; ?>/assets-icons/output/icons.fallback.css"]);
		</script>
		<noscript><link href="../<?php echo $csssite; ?>/assets-icons/output/icons.fallback.css" rel="stylesheet"></noscript>
...
<input type="hidden" name="form_id" value="search_block_form" />
  ...
  <ul class="main-nav clearfix">
    ...
    <li class="teaching-resources parent clearfix">
      ...
      <ul class="sub-menu">
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="European Framework for Film Education">
            European Framework for Film Education
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Ideas and Values">
            Ideas and Values
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Discover Film from the Past">
            Discover Film from the Past
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Engage with Film in All Its Forms">
            Engage with Film in All Its Forms
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Experience the Art of Film">
            Experience the Art of Film
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Learn About the World">
            Learn About the World
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Creativity in Filmmaking">
            Creativity in Filmmaking
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Experience Film in the Cinema">
            Experience Film in the Cinema
          </a>
        </li>
      </ul>
    </li>
    <li class="film-and-the-curriculum parent clearfix">
      <a href="#" class="parent-item js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Film and the Curriculum">
        Film and the Curriculum
      </a>
      <a href="#" class="sectiontoggle js-ga-event" data-ga-cat="Navigation: Section Toggles" data-ga-label="Section Toggled: Film and the Curriculum">
        <div>
          <i class="sectionexpander icon-arrow-down"></i>
        </div>
      </a>
      <ul class="sub-menu">
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="European Framework for Film Education">
            {{ Multiple Pages to be confirmed }}
          </a>
        </li>
      </ul>
    </li>
    
    <li class="our-websites parent clearfix">
      <a href="#" class="parent-item js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Our Websites">
        Our Websites
      </a>
      <a href="#" class="sectiontoggle js-ga-event" data-ga-cat="Navigation: Section Toggles" data-ga-label="Section Toggled: Our Websites">
        <div>
          <i class="sectionexpander icon-arrow-down"></i>
        </div>
      </a>
      <ul class="sub-menu">
        <li>
          <a href="https://scotlandonscreen.org.uk" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Scotland on Screen">
            Scotland on Screen
          </a>
        </li>
        <li>
          <a href="https://screeningshorts.org.uk" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Screening Shorts">
            Screening Shorts
          </a>
        </li>
        <li>
          <a href="https://languagesonscreen.org.uk" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Languages on Screen">
            Languages on Screen
          </a>
        </li>
        <li>
          <a href="https://movingimageeducation.org" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Moving Image Education">
            Moving Image Education
          </a>
        </li>
      </ul>
    </li>
		<li class="partners parent clearfix">
      <a href="#" class="parent-item js-ga-event" data-ga-cat="Navigation Item" data-ga-label="Partners">
        Partners
      </a>
		</li>
    <li class="about-us parent clearfix">
      <a href="#" class="parent-item js-ga-event" data-ga-cat="Navigation Item" data-ga-label="About Us">
        About Us
      </a>
      <a href="#" class="sectiontoggle js-ga-event" data-ga-cat="Navigation: Section Toggles" data-ga-label="Section Toggled: About Us">
        <div>
          <i class="sectionexpander icon-arrow-down"></i>
        </div>
      </a>
      <ul class="sub-menu">
        <li>
          <a href="#" class=" js-ga-event" data-ga-cat="Navigation Item" data-ga-label="What's On">
            What's On
          </a>
        </li>
        <li>
          <a href="#" class="js-ga-event" data-ga-cat="Navigation Item" data-ga-label="5-19 Programme">
            5-19 Programme
          </a>
        </li>
        <li>
...
<div class="nav__trigger clearfix" id="nav-trigger">
  <div class="trigger__container">
    ...
    <div class="body-wrapper heading-wrapper icon-pattern">
      
      <div class="body-wrapper outsider">
      
      <div class="outside container">
        <h1 style="color: #222">Scottish Film Education: Development Guide</h1>
        
        <h2 style="color: #222" class="heading">Release <span class="lowercase"><?php echo $tagname; ?></span></h2>
          ...
          The CSS reset used is <a href="http://necolas.github.io/normalize.css/" target="blank">Normalize</a> at version <b class="update">3.0.2</b>.
            ...
            <div class="js-tab-ui panels">
              <ul class="js-tabs-list" role="tablist">
                ...
                <a href="https://raw.githubusercontent.com/kinworks/sfe-style-guide/<?php echo $tagname; ?>/html/<?php echo $csssite; ?>/css/sass/_1-normalize.scss" target="_blank">
              ...
              <div class="style js-panel" id="scss<?php echo $scss ?>" role="tabpanel" aria-labelledby="tab<?php echo $scss ?>" data-tabgroup="<?php echo $i ?>" style="display: block;">
                ...
                <pre>
                  <code><?php echo file_get_contents("../".$csssite."/css/sass/_1-normalize.scss"); ?></code>
                </pre>
              </div>
            </div>
          </div>
          ...
          <li>'Skip to content' a11y pattern CSS.</li>
            ...
            <div class="js-tab-ui panels">
              <ul class="js-tabs-list" role="tablist">
                ...
                <a href="https://raw.githubusercontent.com/kinworks/sfe-style-guide/<?php echo $tagname; ?>/html/<?php echo $csssite; ?>/css/sass/_3-defaults.scss" target="_blank">
                  <li role="tab" id="tab<?php echo $scss ?>" aria-controls="scss<?php echo $scss ?>" aria-selected="false" data-tabgroup="<?php echo $i ?>" class="linkout">
                    View Raw File &raquo;
                  </li>
                </a>
              ...
              <div class="style js-panel" id="scss<?php echo $scss ?>" role="tabpanel" aria-labelledby="tab<?php echo $scss ?>" data-tabgroup="<?php echo $i ?>" style="display: block;">
                <h2 class="js-panel__title">SCSS</h2>
                <pre>
                  <code><?php echo file_get_contents("../".$csssite."/css/sass/_3-defaults.scss"); ?></code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div class="guidepattern" id="mixins">
            ...
            <div class="js-tab-ui panels">
              <ul class="js-tabs-list" role="tablist">
                ...
                <a href="https://raw.githubusercontent.com/kinworks/sfe-style-guide/<?php echo $tagname; ?>/html/<?php echo $csssite; ?>/css/sass/_2-mixins.scss" target="_blank">
                  <li role="tab" id="tab<?php echo $scss ?>" aria-controls="scss<?php echo $scss ?>" aria-selected="false" data-tabgroup="<?php echo $i ?>" class="linkout">
                    View Raw File &raquo;
                  </li>
                </a>
              ...
              <div class="style js-panel" id="scss<?php echo $scss ?>" role="tabpanel" aria-labelledby="tab<?php echo $scss ?>" data-tabgroup="<?php echo $i ?>" style="display: block;">
                <h2 class="js-panel__title">SCSS</h2>
                <pre>
                  <code><?php echo file_get_contents("../".$csssite."/css/sass/_2-mixins.scss"); ?></code>
                </pre>
              </div>
            </div>
          </div>
          ...
          <div class="guidepattern colour">
            ...
            <div class="js-tab-ui panels">
              <ul class="js-tabs-list" role="tablist">
                ...
                <a href="https://raw.githubusercontent.com/kinworks/sfe-style-guide/<?php echo $tagname; ?>/html/<?php echo $csssite; ?>/css/sass/_4-colours.scss" target="_blank">
                  <li role="tab" id="tab<?php echo $scss ?>" aria-controls="scss<?php echo $scss ?>" aria-selected="false" data-tabgroup="<?php echo $i ?>" class="linkout">
                    View Raw File &raquo;
                  </li>
                </a>
              ...
              <div class="style js-panel" id="scss<?php echo $scss ?>" role="tabpanel" aria-labelledby="tab<?php echo $scss ?>" data-tabgroup="<?php echo $i ?>" style="display: block;">
                <h2 class="js-panel__title">SCSS</h2>
                <pre>
                  <code><?php echo file_get_contents("../".$csssite."/css/sass/_4-colours.scss"); ?></code>
                </pre>
              </div>
            </div>
          </div>
        ...
        <div class="guidepattern" id="body">
            ...
            <div class="js-tab-ui panels fullwidth">
                ...
                <div class="style js-panel first" id="tab-bodybg-scss-panel" role="tabpanel" aria-labelledby="tab-bodybg-scss" data-tabgroup="bodybg">
                  <h2 class="js-panel__title">SCSS</h2>
                  <pre>
                    <code><?php echo file_get_contents("../".$csssite."/css/sass/patterns/01-body-background.scss"); ?></code>
                  </pre>
                </div>            
                <div class="style js-panel" id="tab-bodybg-css-panel" role="tabpanel" aria-labelledby="tab-bodybg-css" data-tabgroup="bodybg">
                  <h2 class="js-panel__title">Generated CSS</h2>
                  <pre>
                    <code><?php echo file_get_contents("../".$csssite."/css/output/patterns/01-body-background.css"); ?></code>
                  </pre>
                </div>
              </div>
            </div>
            ...
            <div class="guidepattern pattern-layout-cap">
              ...
              <div class="js-tab-ui panels">
                ...
                <div class="style js-panel first" id="tab-layout-cap-scss-panel" role="tabpanel" aria-labelledby="tab-layout-cap-scss" data-tabgroup="layout-cap">
                  <h2 class="js-panel__title">SCSS</h2>
                  <pre>
                    <code><?php echo file_get_contents("../".$csssite."/css/sass/patterns/01-layout-cap.scss"); ?></code>
                  </pre>
                </div>            
                <div class="style js-panel" id="tab-layout-cap-css-panel" role="tabpanel" aria-labelledby="tab-layout-cap-css" data-tabgroup="layout-cap">
                  <h2 class="js-panel__title">Generated CSS</h2>
                  <pre>
                    <code><?php echo file_get_contents("../".$csssite."/css/output/patterns/01-layout-cap.css"); ?></code>
                  </pre>
                </div>
              </div>
            </div>
          ...
          <div class="guidepattern pattern-<?php echo substr(basename($file, ".html"), 3) ;?>">
            ...
            <div class="js-tab-ui panels">
              ...
              <div class="style js-panel" id="scss<?php echo $scss ?>" role="tabpanel" aria-labelledby="tab<?php echo $scss ?>" data-tabgroup="<?php echo $i ?>">
                <h2 class="js-panel__title">SCSS</h2>
                <pre>
                  <code><?php echo file_get_contents("../".$csssite."/css/sass/patterns/".basename($file, ".html").".scss"); ?></code>
                </pre>
              </div>
              <div class="style js-panel" id="css<?php echo $css ?>" role="tabpanel" aria-labelledby="tab<?php echo $css ?>" data-tabgroup="<?php echo $i ?>">
                <h2 class="js-panel__title">Generated CSS</h2>
                <pre>
                  <code><?php echo file_get_contents("../".$csssite."/css/output/patterns/".basename($file, ".html").".css"); ?></code>
                </pre>
              </div>
            </div>
          </div>
