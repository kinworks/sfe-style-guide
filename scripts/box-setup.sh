...
echo "\n";
read -p "==| Copy the IP address of the new droplet and put it in ansible/inventories/webserver. Only press [enter] to continue when you've done this and saved the file..." 
echo "\n";
echo "
...
ansible-playbook --inventory-file=ansible/inventories/webserver --extra-vars "ansible_ssh_user=root ansible_ssh_private_key_file=ansible/keys/id_box-setup timeout=30" ansible/box-setup.yml